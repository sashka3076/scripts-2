...
install_package(){
    ...
    eval $SUDO yum install postfix mc httpd vim nano screen php php-xml php-intl php-ldap php-gd php-pecl-imagick php-pdo php-mbstring php-common php-opcache php-mcrypt php-cli php-gd php-curl php-mysql -y $DEBUG_STD
